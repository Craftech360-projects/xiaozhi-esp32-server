@echo off
REM Setup Piper Server (Windows)

echo 🚀 Setting up Remote Piper TTS Server
echo =======================================
...
if not exist "en_US-amy-medium.onnx" (
    echo Downloading en_US-amy-medium model...
...
echo    en_US-amy-medium (female, clear)
echo    en_US-lessac-medium (male, clear)
