...
(102, 'server.secret', 'da11d988-f105-4e71-b095-da62ada82189', 'string', 1, 'Server secret key'),
(106, 'server.websocket', 'ws://192.168.1.236:8000/xiaozhi/v1/', 'string', 1, 'WebSocket address, multiple separated by semicolon'),
(107, 'server.ota', 'http://192.168.1.236:8002/toy/ota/', 'string', 1, 'OTA address'),
