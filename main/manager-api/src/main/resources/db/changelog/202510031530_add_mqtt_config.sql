...
(106, 'server.websocket', 'ws://192.168.1.235:8000/xiaozhi/v1/', 'string', 1, 'websocket地址，多个用;分隔'),
(107, 'server.ota', 'http://192.168.1.235:8002/toy/ota/', 'string', 1, 'ota地址'),
(600, 'mqtt.broker', '192.168.1.235', 'string', 1, 'MQTT broker IP address or hostname'),
