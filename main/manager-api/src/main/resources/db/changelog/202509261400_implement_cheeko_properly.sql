-- Properly implement Cheeko role for all agents
-- Step 1: Update the template name from 湾湾小何 to Cheeko and add new prompt
...
-- Step 2: Update all other templates to have higher sort values so Cheeko remains default
UPDATE `ai_agent_template`
SET `sort` = `sort` + 1
WHERE `id` != '9406648b5cc5fde1b8aa335b6f8b4f76';

-- Step 3: Apply Cheeko template to ALL existing agents
