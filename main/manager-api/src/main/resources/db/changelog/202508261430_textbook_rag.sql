...
-- changeset xiaozhi:202508261430_textbook_rag

-- Create textbooks table for Textbook RAG System
...
-- rollback DROP TABLE IF EXISTS textbook_processing_logs;
-- rollback DROP TABLE IF EXISTS rag_usage_stats;
-- rollback DROP TABLE IF EXISTS textbook_chunks;
-- rollback DROP TABLE IF EXISTS textbooks;