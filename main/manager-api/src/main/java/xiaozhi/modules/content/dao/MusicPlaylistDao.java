...
/**
 * Music Playlist Data Access Object
 */
@Mapper
public interface MusicPlaylistDao extends BaseMapper<MusicPlaylistEntity> {
     ...
     */
    List<MusicPlaylistEntity> getPlaylistByDeviceId(@Param("deviceId") String deviceId);
     ...
     */
    int batchInsert(@Param("list") List<MusicPlaylistEntity> list);
