...
public class SupabaseAuthServiceImpl implements SupabaseAuthService {
    ...
    @Value("${supabase.url:https://nstiqzvkvshqglfqmlxs.supabase.co}")
    private String supabaseUrl;
    
    @Value("${supabase.anon.key:eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5zdGlxenZrdnNocWdsZnFtbHhzIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTM4NzU4OTEsImV4cCI6MjA2OTQ1MTg5MX0.emltic5RhKi2ZgvqlVN7Qda_FJSni07FXhtCPxNCua0}")
