"""
Process Grade 6 Science textbook PDFs - focused on single collection
Creates only grade_06_science collection
"""
...
async def process_pdfs_to_collection():
    """Process Grade 6 science PDFs directly to the collection"""
    ...
    try:
        ...
        # Find PDF files
        pdf_folder = "D:/cheekofinal/xiaozhi-esp32-server/main/livekit-server/scripts/grade_06_science"
        ...
        for pdf_path in pdf_files:
            try:
                ...
                metadata = {
                    ...
                    "isbn": f"NCERT-06-SCI-CH{chapter_number}",
                ...
                for i, chunk in enumerate(chunks):
                    try:
                        ...
                        if embedding:
                            content_chunk = {
                                "id": int(f"6{chapter_number}{i+1:03d}"),  # Convert to integer: 6 + chapter + chunk number (e.g., 61001, 61002, 62001)
...
async def main():
    ...
    logger.info("=== Grade 6 Science Collection Processing ===")
    ...
    logger.info("Step 1: Creating grade_06_science collection...")
    ...
    # Step 2: Process PDFs
    logger.info("Step 2: Processing Grade 6 Science PDFs...")
    processing_success = await process_pdfs_to_collection()

    if processing_success:
        # Step 3: Test
        logger.info("Step 3: Testing Grade 6 Science queries...")
