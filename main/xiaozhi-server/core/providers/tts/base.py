...
class TTSProviderBase(ABC):
    ...
    def to_tts(self, text):
        ...
        if self.delete_audio_file:
            ...
            # Directly convert to audio data for files that need to be deleted
    ...
    async def open_audio_channels(self, conn):
        ...
        # For streaming processing, please override in subclass
                ...
                if message.sentence_type == SentenceType.FIRST:
                    ...
                    if segment_text:
                        ...
                        if self.delete_audio_file:
                            ...
                            if tts_file:
                                ...
                                audio_datas = self._process_audio_file(
                                    tts_file)
                    ...
                    if tts_file and os.path.exists(tts_file):
                        ...
                        self.tts_audio_queue.put(
                            ...
                            (message.sentence_type, audio_datas,
        ...
        while not self.conn.stop_event.is_set():
            ...
            try:
                ...
                future = asyncio.run_coroutine_threadsafe(
                    ...
                    sendAudioMessage(self.conn, sentence_type,
                                     audio_datas, text),
                ...
                if self.conn.max_output_size > 0 and text:
                    ...
                    add_device_output(
                        self.conn.headers.get("device-id"), len(text))
    ...
    def _get_segment_text(self):
        ...
        # Merge all current text and process uncut part

        full_text = "".join(self.tts_text_buff)

        # Start from unprocessed position
        ...
        if last_punct_pos != -1:
            ...
            # Update processed character position
            self.processed_chars += len(segment_text_raw)

            # If it's the first sentence, set flag to False after finding the first comma
