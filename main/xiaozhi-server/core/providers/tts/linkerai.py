...
class TTSProvider(TTSProviderBase):
        ...
        try:
            ...
            try:
                ...
                logger.bind(tag=TAG).warning(
                    ...
                    f"Voice generation failed {5 - max_repeat_time + 1} times: {text}, error: {e}"
            ...
            if max_repeat_time > 0:
                ...
                logger.bind(tag=TAG).info(
                    ...
                    f"Voice generation successful: {text}, retried {5 - max_repeat_time} times"
                ...
                logger.bind(tag=TAG).error(
                    ...
                    f"Voice generation failed: {text}, please check if network or service is normal"
    ...
    async def text_to_speak(self, text, is_last):
        """Streaming TTS audio processing, only push audio list once per sentence"""
    ...
    async def _tts_request(self, text: str, is_last: bool) -> None:
        ...
        # One PCM frame required bytes: 60 ms × 16 kHz × 1 ch × 2 B = 1 920
        ...
        try:
            ...
            async with aiohttp.ClientSession() as session:
                ...
                async with session.get(
                    ...
                    # flush remaining data insufficient for one frame
                    ...
                    # If last segment, audio acquisition completed
    ...
    def to_tts(self, text: str) -> list:
        ...
        try:
            ...
            with requests.get(
                ...
                logger.info(
                    f"TTS request successful: {text}, time taken: {time.time() - start_time} seconds")
                ...
                for i in range(0, len(pcm_data), frame_bytes):
                    ...
                    if len(frame) < frame_bytes:
                        ...
                        # Last frame may be insufficient, pad with zeros
