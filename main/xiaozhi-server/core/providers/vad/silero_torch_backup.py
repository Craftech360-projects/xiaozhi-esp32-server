"""PyTorch-based Silero VAD implementation (legacy/fallback).

This is the original PyTorch implementation kept as a fallback
...
class VADProvider(VADProviderBase):
    ...
    def reset(self):
        ...
        # PyTorch model doesn't have explicit state reset, but we can reset the model if needed
        pass
