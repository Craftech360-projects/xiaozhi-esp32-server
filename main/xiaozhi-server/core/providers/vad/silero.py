...
class VADProvider(VADProviderBase):
    def __init__(self, config):
        ...
        # At least how many frames are required to be considered as having voice
    ...
    def is_vad(self, conn, opus_packet):
        try:
            ...
            # Process complete frames in buffer (process 512 samples at a time)
            ...
            while len(conn.client_audio_buffer) >= 512 * 2:
                ...
                if speech_prob >= self.vad_threshold:
                    ...
                    # If voice didn't drop below minimum value, continue previous state, judged as having voice
                ...
                # If there was voice before, but no voice this time, and the time difference since last voice activity has exceeded the silence threshold, consider the sentence finished
