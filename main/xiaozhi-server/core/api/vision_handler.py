...
class VisionHandler:
    ...
    async def handle_post(self, request):
        ...
        try:
            ...
            # If smart console is enabled, get model configuration from smart console
            ...
            if not select_vllm_module:
                raise ValueError(
                    "You haven't set a default vision analysis module yet")
    ...
    async def handle_get(self, request):
        ...
        try:
            ...
            if vision_explain and len(vision_explain) > 0 and "null" != vision_explain:
                ...
                message = "MCP Vision interface is not running normally, please open the .config.yaml file in the data directory, find [server.vision_explain], and set the address properly"
