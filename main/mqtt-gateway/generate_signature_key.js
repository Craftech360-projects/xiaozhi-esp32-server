...
console.log("=".repeat(60));
console.log(
  "1. Please keep the generated key secure and do not share it with others"
);
console.log(
  "2. In production environment, it is recommended to use longer keys (64 bytes)"
);
console.log(
  "3. MQTT server needs to be restarted after setting the key to take effect"
);
console.log(
  "4. Clients need to use the same key to generate password signatures when connecting"
);

// If command line argument is provided, generate key with specified length
if (process.argv[2]) {
