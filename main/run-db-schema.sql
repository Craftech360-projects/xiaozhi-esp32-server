-- Connect to your Railway MySQL database and run this:
-- mysql -h nozomi.proxy.rlwy.net -P 25037 -u root -pOcaVNLKcwNdyElfaeUPqvvfYZiiEHgdm railway < main/manager-api/database-schema-updates.sql
